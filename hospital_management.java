package project_console_based;
	...
	public class hospital_management
	{
	    public static void main(String args[])
	    {
	        ...
	        d[0].did = "21";
	        d[0].dname = "Dr.Manali B";
	        d[0].specilist = "ENT";
	        d[0].appoint = "5-11AM";
	        d[0].doc_qual = "MBBS,MD";
	        d[0].droom = 17;
	        d[1].did = "32";
	        d[1].dname = "Dr.Vishal K";
	        d[1].specilist = "Physician";
	        d[1].appoint = "10-3AM";
	        d[1].doc_qual = "MBBS,MD";
	        d[1].droom = 45;
	        d[2].did = "17";
	        d[2].dname = "Dr.Akanksha B";
	        d[2].specilist = "Surgeon";
	        d[2].appoint = "8-2AM";
	        d[2].doc_qual = "BDM";
	        d[2].droom = 8;
	        d[3].did = "33";
	        d[3].dname = "Dr.Prashant";
	        d[3].specilist = "Artho";
	        d[3].appoint = "10-4PM";
	        ...
	        m[0].exp_date = "24-5-25";
	        m[0].med_cost = 55;
	        m[0].count = 8;
	        m[1].med_name = "Combiflam";
	        m[1].med_comp = "Ace pvt";
	        m[1].exp_date = "4-4-26";
	        m[1].med_cost = 500;
	        m[1].count = 5;
	        m[2].med_name = "Flexon MR";
